...
public class PluginUpdatesPolicyProjectTest extends AbstractIntegrationTest {

    @Test
    public void pluginUpdatesPolicyProject() throws IOException, URISyntaxException {
        ...
        BuildResult buildResult = buildProject(
                Paths.get(getClass().getResource("pluginUpdates-policy-project").toURI()), "clean");
